...
/* ══════════════════════════════════════════════════════════
   ROTATE REF — SAĞ TIK ONAYI
   Referans artık bir YÜZ: seçim PanelDrawing'de (extrude-ref yüz seçimiyle
   aynı derinlik döngüsü) yapılır; burada yalnız onay vardır.
══════════════════════════════════════════════════════════ */
...
function RotateRefConfirmOnRightClick() {
  ...
  useEffect(() => {
    ...
    const handler = async (ev: MouseEvent) => {
      ...
      if (!st.panelRotateRefFace) return;
