...
export const AddBoxButton: React.FC<IconButtonProps> = ({ onClick, disabled = false, className = '' }) => (
  ...
  >
    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M1 0.360001C1 0.161178 1.16118 0 1.36 0H18.64C18.8388 0 19 0.161178 19 0.36V17.64C19 17.8388 18.8388 18 18.64 18H1.36C1.16118 18 1 17.8388 1 17.64V0.360001Z" fill="#F0EBEB"/>
      <path d="M2.44 6.12V16.56H12.52V6.12H2.44Z" stroke="black" strokeWidth="0.7"/>
