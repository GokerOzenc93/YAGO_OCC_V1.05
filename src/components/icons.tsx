...
export const AddBoxButton: React.FC<IconButtonProps> = ({ onClick, disabled = false, className = '' }) => (
  ...
  >
    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0.730769 0.365385C0.730769 0.163589 0.894358 0 1.09615 0H18.6346C18.8364 0 19 0.163588 19 0.365385V17.9038C19 18.1056 18.8364 18.2692 18.6346 18.2692H1.09615C0.894358 18.2692 0.730769 18.1056 0.730769 17.9038V0.365385Z" fill="#ffffff"/>
      ...
      <g style={{ mixBlendMode: 'plus-darker' }}>
        <path d="M6.86619 12.1338H3.12099V10.8854H6.86619V7.14022H8.11458V10.8854H11.8598V12.1338H8.11458V15.879H6.86619V12.1338Z" fill="#ffffff"/>
      </g>
    </svg>
  </button>
);
