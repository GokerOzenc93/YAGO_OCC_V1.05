...
interface AppState{
  ...
  // 'dyn' = mevcut akış (pivot → eksen → açı). 'ref' = pivot → nişan noktası →
  // eksen → referans panel → referans nokta → sağ tık. Açı her rebuild'de
  // referans noktadan yeniden çözülür (parametrik bağ).
  panelRotateValueMode:'dyn'|'ref';setPanelRotateValueMode:(m:'dyn'|'ref')=>void;
...
export const useAppStore=create<AppState>((set,get)=>({
  ...
  panelRotateMode:false,setPanelRotateMode:(b)=>set({panelRotateMode:b,...(!b?{panelRotateTargetPanelId:null,panelRotatePivot:null,panelRotatePivotType:null,panelRotateAxis:null,panelRotateValue:0,panelRotateValueMode:'dyn' as const,panelRotateRefArmVertex:null,panelRotateRefTargetPanelId:null,panelRotateRefTargetVertex:null}:{})}),
  ...
  panelRotateValueMode:'dyn',setPanelRotateValueMode:(m)=>set({panelRotateValueMode:m,panelRotateAxis:null,panelRotateRefArmVertex:null,panelRotateRefTargetPanelId:null,panelRotateRefTargetVertex:null}),
